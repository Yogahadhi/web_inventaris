<!-- Modal Delete -->
<div class="modal fade" id="modalStockOpnameDestroy{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">
            ...
            Tutup</button>
        <form action="{{ route('stockopnameDestroy',$item->id) }}" method="post">
            @csrf
            @method('delete')
