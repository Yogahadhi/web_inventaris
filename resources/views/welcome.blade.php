...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      @auth
        <a class="btn-getstarted" href="{{ route ('login') }}">Dashboard</a>
      @else
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
            ...
            <div class="d-flex">
              @auth()
                <a href="{{ route('login') }}" class="btn-get-started">Dashboard</a>
              @else
          ...
          <div class="col-xl-12">
            ...
            <div class="info-wrap">
              <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="200">
                ...
                <div>
                  <h3>Alamat</h3>
                  <p>Jl. Taman Makam Pahlawan No.4, Paropo, Kec. Panakkukang, Kota Makassar, Sulawesi Selatan 90233</p>
                </div>
              </div><!-- End Info Item -->
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>2026</span> <strong class="px-1 sitename">INVENTIK BBPVP MAKASSAR</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
